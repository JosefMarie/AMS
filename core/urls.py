...
urlpatterns = [
    ...
    path('attendance/export/', export_views.export_attendance_excel, name='export_attendance_excel'),
    ...
    path('verify-id/<str:username>/', views.verify_id_view, name='verify_id'),
    path('api/classroom/<int:class_id>/student-cards/', views.classroom_student_cards_api, name='classroom_student_cards_api'),
    ...
    path('api/timetable/save-task/', views.save_timetable_task_api, name='save_timetable_task_api'),
    path('api/timetable/delete-task/<int:task_id>/', views.delete_timetable_task_api, name='delete_timetable_task_api'),
    path('api/timetable/save-settings/', views.save_timetable_settings_api, name='save_timetable_settings_api'),
    path('api/timetable/save-state/', views.save_timetable_state_api, name='save_timetable_state_api'),
    path('api/timetable/save-exam/', views.save_timetable_exam_api, name='save_timetable_exam_api'),
    path('api/timetable/delete-exam/<int:exam_id>/', views.delete_timetable_exam_api, name='delete_timetable_exam_api'),
]
