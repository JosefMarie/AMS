...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('template_type', models.CharField(choices=[('THEORY', 'Delivering (Theory)'), ('PRACTICAL', 'Practical')], default='THEORY', max_length=20)),
                ...
                ('facilitation_technique', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.sessionplan')),
            ],
        ),
        migrations.CreateModel(
            name='Activity',
            fields=[
                ...
                ('time_allocation', models.CharField(blank=True, max_length=50)),
                ('resources_needed', models.TextField(blank=True)),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='core.sessionplan')),
            ],
        ),
        migrations.CreateModel(
            name='StudentMark',
